...
Analisis ini menggunakan pendekatan HR Analytics, Exploratory Data Analysis (EDA), dan referensi ilmiah untuk memastikan insight yang akurat dan dapat ditindaklanjuti (actionable insights).

Dataset

Dataset berasal dari repository Kaggle:
HR Data (Multinational Company) oleh Rohit Grewal
